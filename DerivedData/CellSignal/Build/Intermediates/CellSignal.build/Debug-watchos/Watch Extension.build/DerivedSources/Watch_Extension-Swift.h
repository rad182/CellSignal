...
SWIFT_CLASS("_TtC15Watch_Extension16CSSessionUtility")
@interface CSSessionUtility : NSObject
@property (nonatomic, strong) WCSession * __nullable currentSession;
@property (nonatomic, copy) NSString * __nullable currentRadioAccessTechnology;
@property (nonatomic) NSInteger currentSignalStrengthPercentage;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)refreshComplications;
- (void)updateCurrentRadioAccessTechnologyAndCurrentSignalStrengthPercentage:(void (^ __nullable)(NSString * __nullable, NSInteger))completion;
- (void)reloadComplicationData;
@end


@interface CSSessionUtility (SWIFT_EXTENSION(Watch_Extension)) <WCSessionDelegate>
- (void)sessionReachabilityDidChange:(WCSession * __nonnull)session;
- (void)session:(WCSession * __nonnull)session didReceiveMessage:(NSDictionary<NSString *, id> * __nonnull)message;
@end
...
SWIFT_CLASS("_TtC15Watch_Extension22ComplicationController")
...
SWIFT_CLASS("_TtC15Watch_Extension16GlanceController")
@interface GlanceController : WKInterfaceController
@property (nonatomic, weak) IBOutlet WKInterfaceLabel * __null_unspecified radioTechnologyLabel;
